...
namespace frontend\modules\hospice\components;
...
use frontend\modules\hospice\models\RestaurantSpecFilterRel;
...
class UpdateFilterItems
{
	...
	public static function getFilter($filterState)
	{
		...
		if (isset($aggregateResult['aggregations']['price_group'])) {
			...
			$tmp = [];
			foreach ($aggregateResult['aggregations']['price_group']['buckets'] as $key => $value) {
